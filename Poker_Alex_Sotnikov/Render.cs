	...
	class Render : GameResetInterface {
		...
		private void game_UpdateCards(object sender, EventArgs e)
		{
			if (game.table.cards.Count == 0)
			{
				...
				mainform.pbTableCard1.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.Rubashka;
				mainform.pbTableCard2.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.Rubashka;
				mainform.pbTableCard3.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.Rubashka;
				mainform.pbTableCard4.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.Rubashka;
				mainform.pbTableCard5.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.Rubashka;

				mainform.pbAICard1.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.Rubashka;
				mainform.pbAICard2.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.Rubashka;

				mainform.pbMyCard1.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.ResourceManager.GetObject(game.table.mainplayer.hand[0].ToString());
				mainform.pbMyCard2.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.ResourceManager.GetObject(game.table.mainplayer.hand[1].ToString());
			}
			else
			{
				for (int i = 0; i < game.table.cards.Count; i++)
				{
					if (i == 0)
					{
						mainform.pbTableCard1.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.ResourceManager.GetObject(game.table.cards[i].ToString());
						continue;
					}
					if (i == 1)
					{
						mainform.pbTableCard2.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.ResourceManager.GetObject(game.table.cards[i].ToString());
						continue;
					}
					if (i == 2)
					{
						mainform.pbTableCard3.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.ResourceManager.GetObject(game.table.cards[i].ToString());
						continue;
					}
					if (i == 3)
					{
						mainform.pbTableCard4.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.ResourceManager.GetObject(game.table.cards[i].ToString());
						continue;
					}
					if (i == 4)
					{
						mainform.pbTableCard5.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.ResourceManager.GetObject(game.table.cards[i].ToString());
						continue;
					}
				}
				if ((game.table.gamelog.getMove(0).move == Movements.WinHandsUp) || (game.table.mainplayer.AllIn))
				{
					...
					mainform.pbAICard1.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.ResourceManager.GetObject(game.table.players[k].hand[0].ToString());
					mainform.pbAICard2.BackgroundImage = (Image)Poker_Alex_Sotnikov.Properties.Resources.ResourceManager.GetObject(game.table.players[k].hand[1].ToString());
		...
		private void game_LostUpdateControls(object sender, EventArgs e)
		{
			...
			if (((int)args.move < 4) && (args.player is Human))
			{
				...
				mainform.pbMainPlayer.Image = Poker_Alex_Sotnikov.Properties.Resources.waiting;
				mainform.pbAI1.Image = Poker_Alex_Sotnikov.Properties.Resources.active;
			}
		}
		...
		private void game_GameBegin(object sender, EventArgs e)
		{
			...
			if (game.table.players[0] is Human) mainform.pbAI1.Image = Poker_Alex_Sotnikov.Properties.Resources.active;
		}
